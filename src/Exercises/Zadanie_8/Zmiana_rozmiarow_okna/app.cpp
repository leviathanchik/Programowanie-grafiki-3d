...
void SimpleShapeApplication::init() {
    ...
    this->aspect_ = (float)w/h;
    this->fov_ = glm::pi<float>()/4.0;
    this->near_ = 0.1f;
    this->far_ = 100.0f;
    this->P_ = glm::perspective(this->fov_, this->aspect_, this->near_, this->far_); 
    this->V_ = glm::lookAt(glm::vec3{0.2, -0.2, 1.0}, glm::vec3{0.5f, 0.5f, 0.0f}, glm::vec3{0.0, 0.0, 1.0});
    ...
    glBufferSubData(GL_UNIFORM_BUFFER, 0, sizeof(glm::mat4), &this->P_[0]);
    glBufferSubData(GL_UNIFORM_BUFFER, sizeof(glm::mat4), sizeof(glm::mat4), &this->V_[0]);
    glBindBuffer(GL_UNIFORM_BUFFER, 0);
